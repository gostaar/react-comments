...
const imagePath = process.env.PUBLIC_URL + '/lorem.png';

class Article extends Component {
    render() {
        return ( 
            <div>
                <h1 className="title"> Article principal </h1> 
                <p class="has-text-justified mb-6"> What is Lorem Ipsum ?
                ...
                <img class="mb-6" src={imagePath} alt="lorem" width ="80%"/>
            </div>
